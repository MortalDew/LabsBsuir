/* Task: Create a database of Workers/Vacancies like jobs.tut.by.
		 After deleting Worker/Vacancy add them to a .txt file
		 Search/Add/Remove/Help buttons.
*/
